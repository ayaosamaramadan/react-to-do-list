              ...
              <section>
                ...
                {item.tasks &&
                  ...
                  >
                    ...
                    <button
                      className="dark:text-white dark:border-white text-stone-600 border border-stone-500 hover:border-rose-600 px-4 rounded-full hover:bg-rose-600 hover:text-white transition-colors duration-300 dark:bg-blue-700 dark:hover:bg-blue-800"
